...
const greeting = {
  username: "goyalpramod",
  title: "Hi all, I'm Pramod",
  subTitle: emoji(
...
const skillsSection = {
  ...
  skills: [
    ...
    emoji("⚡ Working with latest applications in the ML world like LLMs and Generative AI"),
    emoji(
      "⚡ Make end to end python applications with FastAPI and Streamlit"
    )
  ],
